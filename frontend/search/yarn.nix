{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    ...
    {
      name = "react_query___react_query_3.38.1.tgz";
      path = fetchurl {
        name = "react_query___react_query_3.38.1.tgz";
        url  = "https://registry.yarnpkg.com/react-query/-/react-query-3.38.1.tgz";
        sha1 = "4892304dae7eca7fa0ab5c8ae3e9748f0fca2df9";
      };
    }
    {
