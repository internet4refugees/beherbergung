...
export type GetColumnsQuery = {
  ...
  get_columns?: Array<{
    ...
    options?: {
      ...
      filter?: { __typename?: "Filter"; operator?: string | null } | null;
      transform?: {
        __typename?: "Transform";
        date2Iso?: {
          __typename?: "Date2Iso";
...
export const GetColumnsDocument = `
  ...
  get_columns(auth: $auth) {
    ...
    `;
export const useGetColumnsQuery = <TData = GetColumnsQuery, TError = unknown>(
  ...
  useQuery<GetColumnsQuery, TError, TData>(
    ...
    fetcher<GetColumnsQuery, GetColumnsQueryVariables>(
      GetColumnsDocument,
      variables
    ),
    options
